...
# --- [나선 fullnode E: 드라이브 백업 스크립트] ---
# 작성일: 2026-04-17
# 전략: AWS EC2 Snapshot/Live DB -> WSL -> Windows E: Drive (rsync)
...
# Windows E: 드라이브 백업 경로 (WSL 마운트 지점)
LOCAL_PATH="/mnt/e/nasun-fullnode-backup/fullnode-db"
LOG_DIR="/mnt/e/nasun-fullnode-backup/logs"
...
if [ $EXIT_CODE -eq 0 ]; then
    echo "[$(date)] === 백업 성공 (E: Drive) ===" >> "$LOG_FILE"
