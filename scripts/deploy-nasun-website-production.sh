...
# CloudFront 설정 (nasun.io + www.nasun.io + uju.nasun.io 동시 서빙)
CLOUDFRONT_DIST_ID="E362CCGDH7WA7C"
...
verify_app_id "$APP_DIR/frontend/dist" "nasun-website" "$PEM_KEY_EXPANDED" "${EC2_USER}@${EC2_HOST}" "$REMOTE_DIR"
