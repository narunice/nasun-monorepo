...
export const SCRATCHCARD_ORIGINAL_PACKAGE_ID = (config.scratchcard as Record<string, string>).originalPackageId as ObjectId | undefined;
...
export const SCRATCHCARD: ScratchcardConfig = {
  ...
  originalPackageId: SCRATCHCARD_ORIGINAL_PACKAGE_ID,
