    ...
    <div className={className}>
      ...
      <button
        ...
        className="w-full px-3 py-2 flex items-center justify-between
          text-sm xl:text-base text-gray-700 dark:text-zinc-300
      ...
      >
        <div className="flex items-center gap-2">
          ...
          {currentChain.type === 'evm' && (
            <span className="text-xs xl:text-sm text-purple-500 dark:text-purple-400 bg-purple-100 dark:bg-purple-900/30 px-1.5 py-0.5 rounded">
              EVM
            </span>
          )}
          {currentChain.testnet && (
            <span className="text-xs xl:text-sm text-amber-500 dark:text-amber-400 bg-amber-100 dark:bg-amber-900/30 px-1.5 py-0.5 rounded">
              Testnet
            </span>
          )}
        </div>
