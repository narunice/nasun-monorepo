...
function LockedStateUI({
  ...
  return (
    <div className="p-4 w-full ">
      ...
      {isLocked && (
        <div className="mb-3 p-2 bg-red-500/20 border border-red-500/50 rounded-md text-sm text-red-400">
      ...
      <div className="flex flex-col gap-2">
        <input
          ...
          className="px-3 py-2 bg-gray-100 dark:bg-zinc-700 border border-gray-300 dark:border-zinc-600 rounded-md text-gray-900 dark:text-white text-sm md:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <div className="flex gap-2 mt-2">
          ...
          <button
            ...
            className="flex-1 px-3 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-zinc-600 disabled:text-zinc-400 text-white font-medium rounded-md text-sm md:text-base transition-colors"
          >
            {isLocked
        ...
        <div className="p-4 w-full ">
          ...
          <div className="flex flex-col gap-2">
            <input
              ...
              value={password}
              onChange={(e) => setPassword(e.target.value)}
              className="px-3 py-2 bg-gray-100 dark:bg-zinc-700 border border-gray-300 dark:border-zinc-600 rounded-md text-gray-900 dark:text-white text-sm md:text-base focus:outline-none focus:ring-2 focus:ring-blue-500"
              disabled={isLoading}
              autoFocus
            />
            ...
            <div className="flex gap-2 mt-2">
              ...
              <button
                ...
                className="flex-1 px-3 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 dark:disabled:bg-zinc-600 disabled:text-gray-500 dark:disabled:text-zinc-400 text-white font-medium rounded-md text-sm md:text-base transition-colors"
              >
      ...
      return (
        <div className="py-3 px-4 w-full ">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-3 py-2 bg-gray-100 dark:bg-zinc-700 rounded-md hover:bg-gray-200 dark:hover:bg-zinc-600 disabled:opacity-50 transition-colors"
              >
                -
              </button>
              ...
              <button
                ...
                className="px-3 py-2 bg-gray-100 dark:bg-zinc-700 rounded-md hover:bg-gray-200 dark:hover:bg-zinc-600 transition-colors"
              >
                +
              </button>
            </div>
            {ledgerAddress && (
              <div className="mt-3 p-2 bg-gray-50 dark:bg-zinc-800 rounded-md text-xs text-gray-600 dark:text-zinc-400 break-all">
                {ledgerAddress}
              </div>
            )}
          </div>
          ...
          <div className="mt-4">
            <button
              onClick={() => setViewMode("main")}
              className="w-full px-3 py-2 text-sm md:text-base bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors"
            >
              Done
            </button>
          </div>
        ...
        <div className="w-full ">
          ...
          <div className="py-2 px-3 space-y-1">
            <button
              ...
              className="w-full px-3 py-2 text-left text-sm md:text-base text-gray-700 dark:text-zinc-300 hover:bg-gray-100 dark:hover:bg-zinc-700 rounded-md transition-colors flex items-center gap-2"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  strokeLinecap="round"
          ...
          <div className="py-2 px-3">
            <button
              ...
              className="w-full px-3 py-2 text-left text-sm md:text-base text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-md transition-colors flex items-center gap-2"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  strokeLinecap="round"
        ...
        <div className="py-3 px-4 w-full ">
          ...
          <div className="space-y-1">
            ...
            <button
              ...
              className="w-full px-3 py-2 text-left text-sm md:text-base text-gray-500 dark:text-zinc-400 hover:bg-gray-100 dark:hover:bg-zinc-700 rounded-md transition-colors flex items-center gap-2"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  strokeLinecap="round"
      ...
      return (
        <div className="w-full ">
          ...
          {nsaIsInitialized && nsaActiveRecoveryId && !showMoreMenu && (
            <div className="mx-3 mt-2 p-2 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-md flex items-center justify-between">
              <div className="flex items-center gap-2">
  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 bg-white dark:bg-zinc-800 hover:bg-gray-50 dark:hover:bg-zinc-700 border border-gray-300 dark:border-zinc-600 rounded-md text-sm md:text-base transition-colors"
      >
      ...
      {showDropdown && !isMobile && (
        <div
          className={`bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-600 rounded-md shadow-lg z-[9999] absolute w-[320px] sm:w-[380px] md:w-[420px] overflow-hidden ${
            dropdownAlign === "left"
              ? "left-0"
        ...
        createPortal(
          <>
            ...
            <div
              ...
              className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100vw-32px)] max-w-[420px] max-h-[85vh] overflow-hidden bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-600 rounded-md shadow-lg z-[99999]"
            >
              {renderDropdownContent()}
            </div>
          </>,
