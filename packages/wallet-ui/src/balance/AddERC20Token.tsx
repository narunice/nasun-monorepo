    ...
    <div className="p-4">
      ...
      <div className="flex gap-2 mb-3">
        <input
          ...
          placeholder="0x..."
          className="flex-1 px-3 py-2 text-sm xl:text-base bg-gray-50 dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-zinc-400 focus:outline-none focus:border-blue-500"
        />
        <button
