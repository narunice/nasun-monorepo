...
export function DisconnectedView({
  ...
  return (
    <div className="py-3 px-4 w-full">
      ...
      {/* Traditional Wallet Options — side by side */}
      <div className="grid grid-cols-2 gap-2">
        <button
          onClick={() => setViewMode("create")}
          className="px-3 py-2 text-sm md:text-base text-gray-500 dark:text-zinc-400 hover:bg-gray-100 dark:hover:bg-zinc-700 rounded transition-colors flex items-center justify-center gap-1.5"
        >
      ...
      <button
        ...
        className="w-full mt-2 px-3 py-2 text-sm md:text-base text-gray-400 dark:text-zinc-500 hover:text-gray-600 dark:hover:text-zinc-300 hover:bg-gray-100 dark:hover:bg-zinc-700 rounded transition-colors flex items-center justify-center gap-1.5"
      >
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
            strokeLinecap="round"
