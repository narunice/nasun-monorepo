...
var collect_likes_exports = {};
__export(collect_likes_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(collect_likes_exports);
...
var handler = async (event) => {
  const startTime = Date.now();
  console.log("\u{1F44D} [COLLECT_LIKES_V3] \uC2DC\uC791:", JSON.stringify(event, null, 2));
  try {
    ...
    console.log(`\u{1F4CA} [BATCH_${batchIndex}] ${tweets.length}\uAC1C \uD2B8\uC717\uC758 \uC88B\uC544\uC694 \uC218\uC9D1 \uC2DC\uC791`);
    ...
    for (const tweet of tweets) {
      try {
        console.log(`\u{1F44D} [TWEET_${tweet.id}] \uC88B\uC544\uC694 \uC218\uC9D1 \uC2DC\uC791`);
        ...
        if (users && users.length > 0) {
          ...
          console.log(`\u{1F512} [TWEET_${tweet.id}] \uC218\uC9D1 \uC644\uB8CC \uB9C8\uD0B9 (Passive - Likes)`);
        } else {
          ...
          console.log(`\u{1F512} [TWEET_${tweet.id}] \uC218\uC9D1 \uC644\uB8CC \uB9C8\uD0B9 (Passive - Likes, 0\uAC1C)`);
        }
      } catch (error) {
...
//# sourceMappingURL=collect-likes.js.map
