...
var get_leaderboard_snapshot_exports = {};
__export(get_leaderboard_snapshot_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(get_leaderboard_snapshot_exports);
...
var handler = async (event) => {
  ...
  try {
    ...
    console.log("\u{1F50D} \uC2A4\uB0C5\uC0F7 API \uC694\uCCAD:", {
      period,
      date,
      path,
    ...
    const leaderboardPeriod = period.toUpperCase();
    ...
    if (!hasMetadata || !hasUsers && !hasEntries) {
      console.log("\u{1F4C5} \uC2A4\uB0C5\uC0F7\uC774 \uC874\uC7AC\uD558\uC9C0 \uC54A\uC74C:", {
        period,
        date,
        hasMetadata,
        hasUsers,
...
//# sourceMappingURL=get-leaderboard-snapshot.js.map
