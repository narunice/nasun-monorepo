...
var get_cumulative_leaderboard_exports = {};
__export(get_cumulative_leaderboard_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(get_cumulative_leaderboard_exports);
...
var handler = async (event) => {
  ...
  try {
    ...
    const period = queryParams.period || "cumulative";
    const date = queryParams.date;
    console.log("\u{1F50D} API \uC694\uCCAD \uD30C\uB77C\uBBF8\uD130:", {
      page,
      limit,
      period,
      date,
    ...
    let leaderboardPeriod;
    switch (period) {
      case "cumulative":
        leaderboardPeriod = "CUMULATIVE" /* CUMULATIVE */;
        break;
      case "event1":
        leaderboardPeriod = "EVENT1" /* EVENT1 */;
        break;
      case "event2":
        leaderboardPeriod = "EVENT2" /* EVENT2 */;
        break;
      case "event3":
        leaderboardPeriod = "EVENT3" /* EVENT3 */;
        break;
      default:
        leaderboardPeriod = "CUMULATIVE" /* CUMULATIVE */;
    }
    ...
    if (date) {
      ...
      if (isEnded) {
        ...
        if (snapshotDate) {
          ...
          isFinalRanking = true;
          console.log(`\u{1F4C5} \uC774\uBCA4\uD2B8 \uC885\uB8CC\uB428 - Final Rankings \uC870\uD68C: ${effectiveDate}`);
      ...
      if (leaderboardResponse.success && (!leaderboardResponse.data || leaderboardResponse.data.entries.length === 0)) {
        console.log("\u{1F504} Cumulative leaderboard for today is empty. Falling back to the latest snapshot (yesterday).");
        const yesterday = /* @__PURE__ */ new Date();
        yesterday.setDate(yesterday.getDate() - 1);
        const yesterdayStr = yesterday.toISOString().split("T")[0];
        const snapshotResponse = await leaderboardService.getLeaderboardSnapshot("CUMULATIVE" /* CUMULATIVE */, yesterdayStr, page, limit);
...
//# sourceMappingURL=get-cumulative-leaderboard.js.map
