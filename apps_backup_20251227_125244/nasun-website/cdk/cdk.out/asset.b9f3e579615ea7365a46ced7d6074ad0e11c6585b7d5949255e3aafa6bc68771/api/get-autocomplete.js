...
var get_autocomplete_exports = {};
__export(get_autocomplete_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(get_autocomplete_exports);
...
var handler = async (event) => {
  ...
  console.log("\u{1F50D} [get-autocomplete] \uC694\uCCAD \uC2DC\uC791", {
  ...
  try {
    ...
    const searchResult = await leaderboardService.searchUsers(period, query, void 0, limit);
