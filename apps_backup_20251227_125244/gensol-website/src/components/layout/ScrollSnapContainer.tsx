  ...
  useEffect(() => {
    ...
    const handleScrollEnd = () => {
      ...
      scrollTimeout = setTimeout(() => {
        ...
        if (closestSection && minDistance > 10 && minDistance < window.innerHeight * 0.1) {
  ...
  useEffect(() => {
    ...
    const handleWheel = (e: WheelEvent) => {
      ...
      if (isTallSection) {
        ...
        const isAtBottom = currentScrollY + viewportHeight >= sectionBottom - 10 // 하단 여유 10px
      ...
      // Container 밖으로 나가는 경우: 일반 스크롤 허용
