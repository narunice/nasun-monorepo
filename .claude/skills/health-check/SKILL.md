...
| Supply Count | `https://5jwfplm8qb.execute-api.ap-northeast-2.amazonaws.com/prod/` |
...
### 5. Lambda APIs (nasun-website) — 22 endpoints
...
| Supply Count | OK | 0.2s | 200 |
| All Supply Counts | OK | 0.2s | 403 |
