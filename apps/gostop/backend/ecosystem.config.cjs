  ...
  apps: [
    {
      ...
      kill_timeout: 5000,
      out_file: './logs/gostop-backend-out.log',
      error_file: './logs/gostop-backend-error.log',
      merge_logs: true,
      time: true,
    },
    {
      ...
      exp_backoff_restart_delay: 1000,
      kill_timeout: 5000,
      out_file: './logs/gostop-indexer-out.log',
      error_file: './logs/gostop-indexer-error.log',
      merge_logs: true,
      time: true,
    },
  ],
