      ...
      <div className="max-w-7xl mx-auto px-5 h-16 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className="hidden sm:inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium rounded-md text-neutral-400 hover:text-neutral-200 transition-colors"
            title="Go to Nasun"
          >
            Nasun
