...
// Test configuration
const API_URL = process.env.GOVERNANCE_API_URL || "https://3n52syk380.execute-api.ap-northeast-2.amazonaws.com/prod";
 ...
 * export GOVERNANCE_API_URL="https://3n52syk380.execute-api.ap-northeast-2.amazonaws.com/prod"
