 ...
 *      --state-machine-arn arn:aws:states:ap-northeast-2:__AWS_DEV_ACCOUNT__:stateMachine:nasun-leaderboard-pipeline \
...
async function main() {
  try {
    ...
    if (RESTORE) {
      ...
      console.log(`     --state-machine-arn arn:aws:states:ap-northeast-2:__AWS_DEV_ACCOUNT__:stateMachine:nasun-leaderboard-pipeline \\`);
