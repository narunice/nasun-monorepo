...
import waveVideoBg from "../../assets/videos/wave-bg-dark-hq-4x-RIFE-RIFE3.1-96fps-cfr21.mp4";
  ...
  return (
    <PageLayout className="relative">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-[1920px] aspect-[16/9] min-h-[700px] z-0">
        ...
        {/* Radial Gradient Overlay - Top Right Corner (nasun-scarlet to transparent) */}
        <div
          className="absolute inset-0 pointer-events-none"
          style={{
            background:
              "radial-gradient(circle at top right, rgba(250, 49, 2, 0.40) 0%, transparent 35%)",
          }}
        />
