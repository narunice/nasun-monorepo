...
**Wave 1 Battalion NFT 이벤트**를 통해 초기 커뮤니티를 구축하고, X(Twitter) 참여도를 높이는 동시에 안전하고 확장 가능한 Web3 이벤트 시스템을 구축합니다.
...
✅ **페이지 제목**: "Wave 1 Battalion NFT Drop"
✅ **Stepper Progress**: Step 1이 활성화됨
✅ **카드 표시**:

- 아이콘 (파란색 책 모양)
- 제목: "Wave 1 Battalion NFT 이벤트"
- 설명 텍스트
  ✅ **요구사항 섹션**:
- 📋 참여 조건
- ✅ @Nasun_io 팔로우
