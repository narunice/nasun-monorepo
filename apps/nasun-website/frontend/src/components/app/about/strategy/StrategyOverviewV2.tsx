...
const StrategyOverviewV2 = () => {
  return (
    <div className="flex flex-col gap-6 md:gap-8 lg:gap-10 w-full max-w-[1200px] mx-auto px-4 py-12 md:py-20">
      {/* Page Title */}
      <PageTitle className="normal-case ">
        NASUN: A Unified Vision <br></br>
        <span className="text-xl/tight md:text-2xl/tight lg:text-3xl/tight tracking-wide text-nasun-white ">
      ...
      <section>
        ...
        <div className="space-y-2 md:space-y-3 lg:space-y-4 ">
          ...
          <p>
            AI tools, social platforms, and global connectivity allow millions of people to create,
            share, and collaborate instantly. Yet despite this explosion of activity, very little
            lasting value is being created, economically, culturally, or socially.
          </p>
          <p>
          ...
          <DividerBox
            color="n1"
            className="my-4 md:my-6 lg:my-8 !bg-[#242424]/70 !px-4 md:!px-5 lg:!px-6 !py-3 md:!py-4 lg:!py-5 "
          >
            <ul className="space-y-4">
              <li>
                <strong className="text-nasun-white">The Attention Trap:</strong> Content is
                produced, consumed, and forgotten in seconds.
              </li>
              <li>
                <strong className="text-nasun-white">The Meaning Gap:</strong> AI makes content
                infinite, but meaning and value increasingly scarce.
              </li>
              <li>
                <strong className="text-nasun-white">The Extraction Model:</strong> Creators, fans,
          ...
          <p>
            ...
            together and to share in the value as those worlds grow into games, films, applications,
      ...
      <section>
        ...
        <div className="space-y-2 md:space-y-3 lg:space-y-4">
          ...
          <p>
            We treat technology, AI, social media, and Web3, as a unified stack designed to guide a
            project from a spark of an idea to a living, global IP.
          </p>
          <p>
        ...
        <div className="grid grid-cols-1 gap-8 mt-2 md:mt-3 lg:mt-4">
          ...
          <DividerBox color="n1" title="II. The Network as an Economic Backbone">
            <div className="space-y-4 text-nasun-white/90 text-lg font-light">
              <p>
              ...
              <p>
                ...
                the Move programming language, it allows us to track contributions, attribution, and
                ownership at a granular level across creative and financial work alike.
              </p>
              <p>
                When an IP succeeds through a game release, film, or financial service, value flows
                transparently back to the community that created it, not to a centralized
                intermediary.
              </p>
              <p>
                Blockchain infrastructure exists here for one reason: to make shared ownership real.
              </p>
            </div>
          </DividerBox>

          <DividerBox color="n1" title="III. A Seamless, Human-First Experience">
            <div className="space-y-4 text-nasun-white/90 text-lg font-light">
              ...
              <ul className="list-disc pl-6 space-y-2 marker:text-nasun-white/50">
                <li>
                  <strong className="text-nasun-white">Social Media</strong> acts as our discovery
                  and cultural engine
                </li>
                <li>
                  <strong className="text-nasun-white">Generative AI</strong> accelerates production
                  and synthesis
                </li>
                <li>
      ...
      <section>
        ...
        <div className="space-y-2 md:space-y-3 lg:space-y-4">
          ...
          <p>
            It grew out of real production work, on film sets, in editing rooms, and inside studios
            where stories are refined, teams are aligned, and finished work must meet professional
            standards.
          </p>
          <p>
            Our founders bring a rare combination of cinematic storytelling and systems engineering.
            Our lead, Naru, is a professional filmmaker who has served as head editor and producer
            on seminal South Korean films recognized at Cannes, Berlin, and Venice. Our ecosystem
            lead, Overclocked, brings over 20 years of experience in media production and hands-on
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-2 md:mt-3 lg:mt-4">
          <DividerBox
            color="c1"
            className="!border-nasun-c1/50  !bg-[#242424]/70"
            titleClassName="!text-nasun-c1"
            title="1. Signal Aggregation"
          >
          ...
          <DividerBox color="n4" className="" title="2. Open Collaboration">
            <p className="text-nasun-white/90 text-lg font-light">
              Creative development unfolds in public, with ideas evolving through discussion,
              experimentation, and feedback.
            </p>
          </DividerBox>
          <DividerBox color="n5" className="" title="3. Proposal Formation">
            <p className="text-nasun-white/90 text-lg font-light">
          ...
          <DividerBox color="n2" className="" title="4. On-Chain Execution">
            <p className="text-nasun-white/90 text-lg font-light">
      ...
      <section>
        ...
        <div className="space-y-2 md:space-y-3 lg:space-y-4">
          ...
          <p>
            Nasun is not focused on launching hundreds of disposable applications. We are building a
            small number of world-class experiences that invite participation, reward contribution,
            and endure.
          </p>
          <p>The strongest communities in history were formed by shared stories and shared work.</p>
          <p>
            Nasun is the infrastructure that allows the next ones to be built, together, in public,
            and with ownership that lasts.
          </p>
        </div>
      </section>
    </div>
