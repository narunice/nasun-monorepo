  ...
  return (
    <BattalionNftCard>
      <div className="text-center">
        ...
        <h3 className="!font-rubik font-medium mb-4 max-w-xl mx-auto">{t("step1.title")}</h3>
        <p className="mb-6">{t("header.description")}</p>
        <div className="space-y-4 md:space-y-8 mb-4 md:mb-8">
          ...
          >
            <ul className="space-y-2 ">
              ...
              <li className="flex items-start gap-2">
                <FiCheck className="mt-1 flex-shrink-0" /> {t("step1.requirements.item4")}
              </li>
            </ul>
          ...
          <DividerBox color="c3" icon="🎁" title={t("step1.rewards.title")} className="text-left">
        ...
        <Button onClick={onStartClick} variant="c5" className="w-full" size="2xl">
          {t("step1.button")}
        </Button>
      </div>
    </BattalionNftCard>
