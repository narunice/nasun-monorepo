    ...
    <SectionLayout className="!max-w-6xl">
      <FadeInUp>
        ...
        <div className="mb-3 md:mb-4 lg:mb-5 xl:mb-6 flex flex-col items-center">
          <h4 className="text-nasun-c3/90 font-semibold text-center">
      ...
      <FadeInUp>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-7 lg:gap-8">
          {advantages.map((item) => (
            <div
              key={item.key}
              className="border border-nasun-c3/50 rounded-2xl bg-[#1d2d2a] backdrop-blur-md p-6 md:p-8 transition-all hover:border-nasun-c3 hover:bg-nasun-c3/15 min-h-[140px] md:min-h-[160px]"
            >
