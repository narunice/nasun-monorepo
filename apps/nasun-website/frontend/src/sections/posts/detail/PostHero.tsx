    ...
    <div className="relative w-full min-h-28 md:min-h-32 flex flex-col justify-end overflow-hidden">
      ...
      <div className="relative z-20 pt-24 md:pt-28 pb-6 md:pb-10 px-4">
        <div className="max-w-5xl mx-auto text-center md:text-left">
          <button
            onClick={onBack}
            className="inline-flex items-center text-nasun-c1 hover:text-nasun-c2 transition-colors mb-6 text-xs md:text-sm lg:text-base uppercase tracking-[0.2em] font-medium"
          >
