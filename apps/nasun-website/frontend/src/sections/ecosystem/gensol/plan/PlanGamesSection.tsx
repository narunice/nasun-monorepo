...
const GAMES: Game[] = [
  {
    ...
    icon: Gamepad2,
    body: "Teams crash-land on hostile alien worlds and race to extract Spectra before the environment kills everyone. Built in Unreal Engine C++. Playable prototype with dedicated servers, multiple weapon classes, server-rewind hit detection.",
