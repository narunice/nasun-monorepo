// uju-native copy of NftShowcaseCard. Image-prominent NFT cards for the uju dashboard.
// Renders Genesis Pass (priority), Alliance, and Battalion stacked vertically.
...
interface UjuNftShowcaseCardProps {
  className?: string;
}

export const UjuNftShowcaseCard: FC<UjuNftShowcaseCardProps> = ({
  className = "",
}) => {
