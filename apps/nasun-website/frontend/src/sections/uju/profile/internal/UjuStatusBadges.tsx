...
export const UjuLoggedInBadge: FC = () => (
  <span
    className="inline-flex items-center gap-1 px-2 py-0.5 rounded-lg bg-pado-2/10 text-pado-2 text-sm font-normal uppercase tracking-wider border border-pado-2/20"
  >
...
export const UjuLinkedBadge: FC = () => (
  <span
    className="inline-flex items-center gap-1 px-2 py-0.5 rounded-lg bg-uju-bg border border-uju-border/30 text-uju-secondary text-sm font-normal uppercase tracking-wider"
  >
...
export const UjuConnectedBadge: FC = () => (
  <span
    className="inline-flex items-center gap-1 px-2 py-0.5 rounded-lg bg-pado-4/10 text-pado-4 text-sm font-normal uppercase tracking-wider border border-pado-4/20"
  >
    <Check className="w-3 h-3 flex-shrink-0" />
