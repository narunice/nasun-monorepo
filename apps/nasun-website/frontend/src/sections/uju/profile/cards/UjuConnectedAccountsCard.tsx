...
import { UjuConnectedBadge, UjuLinkedBadge, UjuLoggedInBadge, UjuChannelMemberBadge } from "../internal/UjuStatusBadges";
...
export const UjuConnectedAccountsCard: FC<UjuConnectedAccountsCardProps> = ({ className = "", bare = false }) => {
  const { user } = useAuth();
  ...
  // Hooks
  const { isLinking, handleLinkGoogle, handleLinkTwitter, unlinkAccount } = useUjuAccountLinking({ user });
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4">
          ...
          <div className="text-xs">
            ...
            {disclaimerExpanded && (
              <ul className="mt-3 space-y-2 pl-1 text-uju-secondary/80 leading-relaxed font-medium">
                ...
                <li className="flex gap-2"><span className="text-pado-2">•</span> Back up your Nasun Wallet now to ensure recovery.</li>
              </ul>
            )}
          </div>
        </UjuAccountItem>
        ...
        <UjuAccountItem
          ...
          statusBadge={
            isTwitterPrimary ? <UjuLoggedInBadge /> : twitterData ? <UjuLinkedBadge /> : undefined
          }
          actions={[
        ...
        <UjuAccountItem
          ...
          statusBadge={
            isGooglePrimary ? <UjuLoggedInBadge /> : googleData ? <UjuLinkedBadge /> : undefined
          }
          actions={[
            !googleData ? (
              <UjuButton
        ...
        <UjuAccountItem
          ...
          statusBadge={telegram.isVerified ? <UjuChannelMemberBadge /> : undefined}
          actions={[
            !telegram.isVerified && !telegram.isLoading ? (
              <UjuButton key="join" size="sm" variant="secondary" as="a" href="https://t.me/nasun_official" target="_blank" rel="noopener noreferrer">
                Join
              </UjuButton>
            ) : null,
            !telegram.isVerified && !telegram.isLoading ? (
