...
function DevNewsEventsSection() {
  ...
  return (
    <SectionLayout id="dev-news-events" className="relative min-h-screen bg-nasun-black">
      <FadeInUp>
                ...
                {posts.map((post) => {
                  ...
                  return (
                    <Link key={post.id} to={`/news-events/${post.slug}`} className="block px-2">
                      <div className="group flex flex-col md:flex-row bg-nasun-white overflow-hidden transition-all duration-300 rounded-sm">
