...
const REPLY_ALLOWED_STATUSES: Array<BugReport["status"]> = ["fixed", "wont-fix"];
                ...
                >
                  ...
                  {isExpanded && (
                    <div className="px-3 pb-3 pt-0 border-t border-white/5 space-y-2">
                      ...
                      {report.userReply && (
                        <div>
                          <span className="text-sm text-white/60 block">Your Follow-up</span>
  ...
  return (
    <div className="pt-2 space-y-2">
      <span className="text-sm text-white/60 block">
        {report.userReply ? "Editing your previous reply" : "Still having this issue? Send a follow-up"}
      </span>
      <textarea
        value={text}
