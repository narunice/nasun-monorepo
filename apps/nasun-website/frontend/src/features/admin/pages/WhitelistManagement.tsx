            ...
            <tbody>
              {entries.map((entry) => (
                <tr key={entry.walletAddress} className="border-b border-nasun-c5/20 hover:bg-nasun-c5/5">
                  ...
                  <td className="py-2 pr-4 text-nasun-white/60">{entry.registeredAt ? new Date(entry.registeredAt).toLocaleString("en-US", { month: "short", day: "numeric", year: "numeric", hour: "2-digit", minute: "2-digit", second: "2-digit" }) : "-"}</td>
