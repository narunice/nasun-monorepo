 ...
 *
 * Manual curation interface for community engagement tracking.
 * Requires admin authentication via AdminRoute.
 * Supports keyboard shortcuts for fast input.
 *
 * Keyboard Shortcuts:
  ...
  return (
    <AdminLayout>
      <div className="bg-nasun-black min-h-screen">
        <SectionLayout className="!max-w-4xl !pt-12">
          {/* Header */}
          <div className="w-full mb-8 text-left">
            ...
            <p className="text-nasun-white/60 text-lg font-light max-w-2xl leading-relaxed">
              Register community posts for the leaderboard. Use keyboard shortcuts for faster input.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-6 w-full">
            ...
            <OuterBox color="n3" padding="sm" className="w-full">
              <div className="flex items-center gap-4">
                <label className="text-xs uppercase tracking-widest text-nasun-white/50 font-medium whitespace-nowrap">
                  Admin Username (optional)
                </label>
                <input
                  type="text"
                  ...
                  className="flex-1 bg-gray-800/50 border border-nasun-c5/30 rounded-lg px-3 py-2 text-sm text-nasun-white placeholder:text-nasun-white/30 focus:outline-none focus:border-nasun-c3/50 transition-colors"
                />
              </div>
            </OuterBox>
          </div>
