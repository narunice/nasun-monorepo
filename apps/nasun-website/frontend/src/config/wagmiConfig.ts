...
// - All other environments: metaMaskWallet + walletConnectWallet
//   (EIP-6963 auto-detects Rabby, Brave, etc. on desktop;
//    RainbowKit handles native deep links on mobile)
