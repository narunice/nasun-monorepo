...
| 환경 | 주소 | 포트 | PM2 이름 |
|---|---|---|---|
| Prod | `43.200.67.52` (ec2-user) | 3101 | `nasun-chat-server` |
| Staging | `15.165.19.180` (ubuntu) | 3101 | `nasun-chat-server` |
...
Prod(43.200.67.52)에서 PR#1 A-0 측정:
...
rsync -avz --delete \
  ...
  ubuntu@15.165.19.180:~/nasun-chat-server/
...
rsync -avz --delete \
  ...
  apps/nasun-website/chat-server/ \
  ec2-user@43.200.67.52:~/nasun-chat-server/
