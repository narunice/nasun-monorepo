...
5. [Phase 3: 스마트컨트랙트 보안](#5-phase-3-스마트컨트랙트-보안) ✅ 완료 (SC 배포됨)
...
Phase 3: 스마트컨트랙트  [Day 1-2]    ████████████████████████████ ✅ 완료 (SC 배포됨)
Phase 4: DeFi 보안       [Day 1]      ████████████████████████████ ✅ FE 완료

✅ 지갑 보안: 별도 세션에서 완료 (섹션 8 참조) - HIGH 3/3 해결
✅ SC 배포: pado_tokens, prediction 패키지 Nasun Devnet 배포 완료
✅ DeepBook 풀: NBTC/NUSDC, NASUN/NUSDC 풀 생성 완료
```
...
| apps/pado | 0 | 4 | 5 | ✅ Phase 3 완료 (SC 배포됨) |
...
### 5.4 스마트컨트랙트 보안 ✅ 완료 (2026-01-01)

> **배포 완료**: Nasun Devnet에 보안 강화된 컨트랙트가 새로 배포되었습니다.

#### 5.4.1 배포된 패키지

| 패키지 | ID | 설명 |
|--------|-----|------|
| pado_tokens | `0xb083f14e6d768d6ccb7bb95b225a06d65fa41a14aea4c8d102ae1a104835c1d7` | NBTC, NUSDC, Faucet |
| prediction | `0x6754f5806b9bb348f570e350b1309deb5bd9469d0d3000455b1ce368ef4085eb` | Prediction Market |

#### 5.4.2 보안 강화 내용

**Faucet 24시간 쿨다운:**
- `ClaimRecord` shared object로 마지막 청구 시간 추적
- `request_tokens_with_cooldown()` 함수: 24시간 쿨다운 적용
- 기존 `request_tokens()` 함수: 하위 호환성 유지

**NBTC 민팅 상한선:**
- `MAX_SUPPLY`: 21,000,000 NBTC (8 decimals)
- `mint()` 함수에서 supply 체크 추가

#### 5.4.3 배포된 Shared Objects
...
| AdminCap (prediction) | `0x9e06794a20be24f3be11558351125924aed98a6ac03c1d1ec212c3197fb9a3c6` |

#### 5.4.4 Prediction Test Markets

4개의 테스트 마켓이 생성되었습니다:

| Market | ID | Close Time |
|--------|-----|------------|
| BTC $150k by March 2026 | `0xdc90...71b8` | 2026-03-01 |
| TikTok Ban by March 2026 | `0x0a1f...2fe5` | 2026-03-01 |
| HUNTR/X Grammy 2026 | `0xb185...577b` | 2026-02-04 |
| Russia-Ukraine Ceasefire | `0x7a04...4805` | 2026-06-30 |

#### 5.4.5 DeepBook V3 풀 생성 ✅ 완료

**해결됨**: AdminCap을 현재 지갑으로 transfer 후 풀 생성 완료

| Pool | ID | Tick Size | Lot Size |
|------|-----|-----------|----------|
| NBTC/NUSDC | `0xd19dfb9a51424a2193ef4284a1bf67d3c03b5ef3132446016243f9d394ef7180` | $0.01 | 0.0001 BTC |
| NASUN/NUSDC | `0x9022d534d9846cbc32341fe07d4444be142065d0b7b2cc11a16ffe53a2e7d0f2` | $0.001 | 0.01 NASUN |

**태그**: `security-phase3-pools-created`

#### 5.4.6 재배포 가이드

상세 재배포 절차: [PADO_REDEPLOYMENT_GUIDE.md](../../../docs/PADO_REDEPLOYMENT_GUIDE.md)
