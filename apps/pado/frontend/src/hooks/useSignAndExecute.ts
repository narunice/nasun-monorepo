/**
 * useSignAndExecute Hook
 *
 * Unified sign + execute across all 3 auth paths: zkLogin, passkey, local wallet.
 * Extracted from usePredictionTrade so other features (recovery, lottery, etc.)
 * can reuse the same auth-aware signer.
 */
