    ...
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] xl:grid-cols-[3fr_2fr] gap-4 md:gap-6">
        <main className="space-y-4 md:space-y-6 order-2 lg:order-1">
          ...
          <CancelExpiredMarketCTA market={market} onSuccess={handleRefetch} />
          ...
          {/* Admin Section — only the designated resolver sees this. */}
          {isResolver && market.status === 'open' && (
        ...
        <aside className="space-y-4 md:space-y-6 order-1 lg:order-2">
          <OutcomeOrderForm
            market={market}
            yesOrderbook={yesOrderbook}
            noOrderbook={noOrderbook}
