        ...
        return (
          <button
            ...
            className={`inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-full text-[11px] transition-colors ${
              isMine
                ? 'bg-theme-accent/10 border border-theme-accent/15 text-theme-accent'
                : 'bg-theme-text-primary/5 border border-theme-text-primary/5 text-theme-text-primary/70 hover:bg-theme-text-primary/10'
            }`}
          >
            <span>{emoji}</span>
            <span>{count}</span>
