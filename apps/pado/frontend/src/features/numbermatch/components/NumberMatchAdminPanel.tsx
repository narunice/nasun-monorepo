...
import { useNumberMatchAdmin } from '../hooks/useNumberMatchAdmin';
import { useNumberMatchPool } from '../hooks/useNumberMatchPool';
import { formatNusdc } from '../types';
import { Spinner } from '../../../components/common';

export function NumberMatchAdminPanel() {
    ...
    <div className="space-y-4">
      ...
      {pool && (
        <div className="grid grid-cols-2 gap-2 text-sm">
          ...
          <div className="text-theme-text-muted">Total Plays</div>
          <div>{pool.totalPlays}</div>
          ...
          <div>{pool.dailyPlayCount} plays</div>
        </div>
      )}
