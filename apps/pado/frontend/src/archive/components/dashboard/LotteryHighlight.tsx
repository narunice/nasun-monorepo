  ...
  if (!currentRound) {
    return (
      <div className="bg-theme-bg-secondary border border-theme-border rounded-xl p-4">
        ...
        <Link to="/games/lottery" className="text-sm xl:text-base text-pd3 hover:text-pd4 font-medium">
          View Lottery &rarr;
        </Link>
      </div>
    );
  ...
  return (
    <div className="bg-theme-bg-secondary border border-theme-border rounded-xl p-4">
      <div className="flex items-center justify-between mb-1">
        ...
        <Link to="/games/lottery" className="text-xs xl:text-sm text-pd3 hover:text-pd4">
          View All &rarr;
        </Link>
      </div>
