  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Prediction market YES/NO — desaturated, theme-aware
        'predict-yes': 'var(--color-predict-yes)',
        'predict-yes-strong': 'var(--color-predict-yes-strong)',
        'predict-yes-bar': 'var(--color-predict-yes-bar)',
        'predict-yes-bar-hover': 'var(--color-predict-yes-bar-hover)',
        'predict-yes-bg-soft': 'var(--color-predict-yes-bg-soft)',
        'predict-yes-bg': 'var(--color-predict-yes-bg)',
        'predict-yes-bg-strong': 'var(--color-predict-yes-bg-strong)',
        'predict-yes-border': 'var(--color-predict-yes-border)',
        'predict-no': 'var(--color-predict-no)',
        'predict-no-strong': 'var(--color-predict-no-strong)',
        'predict-no-bar': 'var(--color-predict-no-bar)',
        'predict-no-bar-hover': 'var(--color-predict-no-bar-hover)',
        'predict-no-bg-soft': 'var(--color-predict-no-bg-soft)',
        'predict-no-bg': 'var(--color-predict-no-bg)',
        'predict-no-bg-strong': 'var(--color-predict-no-bg-strong)',
        'predict-no-border': 'var(--color-predict-no-border)',
        // Notice card (e.g. "Awaiting Resolution")
        'notice-text': 'var(--color-notice-text)',
        'notice-text-muted': 'var(--color-notice-text-muted)',
        'notice-bg': 'var(--color-notice-bg)',
        'notice-bg-strong': 'var(--color-notice-bg-strong)',
        'notice-border': 'var(--color-notice-border)',
        'notice-track': 'var(--color-notice-track)',
        // Toggle switch
