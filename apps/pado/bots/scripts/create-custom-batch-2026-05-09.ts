/**
 * Custom batch (2026-05-09):
 *   Crypto + US stock prediction markets closing 3, 4, and 5 days out.
 *   Mirrors create-custom-batch-2026-05-06.ts on-chain signature so the
...
const SPECS: Spec[] = [
  { kind: 'stock',  ticker: 'AAPL', market: 'NYSE', currency: 'USD', displayName: 'Apple Inc.',          daysOut: 3, biasPct: +1.0, label: 'AAPL 3d-close' },
  { kind: 'crypto', symbol: 'XRP', binanceSymbol: 'XRPUSDT', displayName: 'XRP',     decimals: 4, daysOut: 5, biasPct: +2.0, label: 'XRP 5d' },
];
