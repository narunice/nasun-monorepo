/**
 * FIFA World Cup 2026 prediction-market batch creator -- second batch (TheSportsDB).
 *
 * Emits ONE binary market per fixture:
 *   home_win          -> "Will <home> beat <away>?" (draw resolves NO)
 *
 * Covers the remaining group-stage round-1 fixtures that did NOT yet have a
 * market. Deliberately EXCLUDES:
 *   - the 5 fixtures already created by create-worldcup-batch-2026-06.ts
 *     (Mexico/SA, Korea/Czech, USA/Paraguay, Brazil/Morocco, Germany/Curacao)
 *   - Canada vs Bosnia-Herzegovina (2461104): kickoff was too imminent at
 *     authoring time (close = kickoff - 5min already near).
 *
 * EventIds, home/away orientation and kickoff UTC verified 2026-06-12 against
 * https://www.thesportsdb.com/api/v1/json/3/eventsseason.php?id=4429&s=2026
 * (league 4429 = FIFA World Cup; strTimestamp is UTC). home_win resolves from
 * intHomeScore/intAwayScore, so home/away orientation must match TheSportsDB.
 *
 * Required env:
 ...
 *        apps/pado/bots/scripts/create-worldcup-batch-2026-06b.ts --dry-run
 */
...
// 9 remaining group-stage round-1 fixtures, one home_win market each.
const FIXTURES: Fixture[] = [
  {
    eventId: '2391732',
    homeTeam: 'Qatar',
    awayTeam: 'Switzerland',
    kickoffUtc: '2026-06-13 19:00:00 UTC',
    kinds: ['home_win'],
  },
  {
    eventId: '2391731',
    homeTeam: 'Haiti',
    awayTeam: 'Scotland',
    kickoffUtc: '2026-06-14 01:00:00 UTC',
    kinds: ['home_win'],
  },
  {
    eventId: '2461105',
    homeTeam: 'Australia',
    awayTeam: 'Turkey',
    kickoffUtc: '2026-06-14 04:00:00 UTC',
    kinds: ['home_win'],
  },
  {
    eventId: '2391735',
    ...
    awayTeam: 'Japan',
    kickoffUtc: '2026-06-14 20:00:00 UTC',
    kinds: ['home_win'],
  },
  {
    eventId: '2391734',
    ...
    awayTeam: 'Ecuador',
    kickoffUtc: '2026-06-14 23:00:00 UTC',
    kinds: ['home_win'],
  },
  {
    eventId: '2461106',
    homeTeam: 'Sweden',
    awayTeam: 'Tunisia',
    kickoffUtc: '2026-06-15 02:00:00 UTC',
    kinds: ['home_win'],
  },
  {
    eventId: '2391739',
    homeTeam: 'Spain',
    awayTeam: 'Cape Verde',
    kickoffUtc: '2026-06-15 16:00:00 UTC',
    kinds: ['home_win'],
  },
  {
    eventId: '2391736',
    homeTeam: 'Belgium',
    awayTeam: 'Egypt',
    kickoffUtc: '2026-06-15 19:00:00 UTC',
    kinds: ['home_win'],
  },
  {
    eventId: '2391738',
    ...
    awayTeam: 'Uruguay',
    kickoffUtc: '2026-06-15 22:00:00 UTC',
    kinds: ['home_win'],
  },
];
