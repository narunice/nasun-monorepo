...
| Points System | ✅ | 100% | 거래/볼륨/다양성 기반 포인트 + 리더보드 탭 |
| Passkey Auth | ✅ | 100% | 디바이스 크레덴셜 기반 인증 (생체인식) |
| TP/SL Keeper | ✅ | 100% | TradeCap 위임, 서버사이드 실행 (포트 4001) |
...
│  ├── Passkey (Device credentials) [Implemented]             │
...
| Production | `__PROD_EC2_HOST__` (ec2-user) | `0xe1c4c90b...6dfb3d90` | `hopeful-malachite` |
...
└── ai-chatbot.ts          # Claude Haiku AI 통합 (선택적, ~$0.04/일)
```
...
| 파일 | 설명 |
|------|------|
| [docs/PADO_NEXT_STEPS.md](docs/PADO_NEXT_STEPS.md) | 다음 기능 우선순위 + Post-Launch 개선 항목 |
| [docs/COMPETITIVE_ANALYSIS.md](docs/COMPETITIVE_ANALYSIS.md) | 경쟁 분석 및 개선 로드맵 |
| [docs/SOCIAL_LAYER_DISCUSSION.md](docs/SOCIAL_LAYER_DISCUSSION.md) | Social Layer 전략 분석 (Finance-first social thesis) |
...
| [docs/PADO_PITCHDECK_TEXT.md](docs/PADO_PITCHDECK_TEXT.md) | VC 피치덱 텍스트 |
| [bots/README.md](bots/README.md) | 봇 문서 (LP Bot, Price Updater, Liquidation Keeper, TP/SL Keeper) |
...
4. **Market Narrator 풀 이름 하드코딩**: `formatAlert`에서 "NBTC" 하드코딩, 다른 풀 추가 시 수정 필요
