...
async function main() {
  const result = await sql`
    SELECT 
        ...
        COUNT(DISTINCT CASE WHEN category IN ('gostop-lottery', 'gostop-numbermatch', 'gostop-mines', 'gostop-crash', 'gostop-scratchcard', 'pado-prediction') THEN identity_id END) as unique_gamers,
