...
const TWEET_ID = '2052959708710093089';

// Paste the raw text from the user here. The script extracts @handles
// automatically — any format works (mentions, lists, prose, etc.).
const RAW_INPUT = `
@0hmybo @0x_nonol @4seazons263 @__Jayden007 @a_lyron @abdabdtuyul77 @Abe_qearo @AdlieI46077 @afrizal_jmb @Alex1974ap @Anton4599262075 @babupengu @baegseungh7061 @BernadetaD70810 @bianca532650 @BLVCK707 @BornG69 @ChangeMyLuv @Cobalt_Duck @Coy2024 @D_O__Y_E @Danzeronero @Diamondcryptx @dixon_eric164 @eglebai @elmeweb3 @elonunmk @erengyegah @GCarr24948 @GoodnessChibui1 @grom60345 @hashafifi @Hwang_Zi1 @I_BlockFive @indah_ye99 @jhon15344147784 @Jonny_KX @JoshMatulessy @JuniorArchej59 @Kaiser507011701 @kall_me_Isaiah @Kennychuot @khagenep @kija888 @Kureshi221 @kythuat_tnec @Lacita776 @larionewlife @Le290788 @m_MED26 @Mariehxt @masud2633 @memonic_johnny @metallover92 @Mn04925907 @mrk_aniket @msaqlainfcma @naro0ck @NgocNguyen63053 @NguynL615156 @nnann021 @NurRohm22672781 @Nyancatoypf @Obidestiny247 @OjoPhilemo17247 @onedreaminvest @only_son_twitte @PemburuCuan069 @phuanvnx @Putri_dhone @qathylu @readnrest0 @ReopaahScrin @Rexxyoo @rocykabilly @safdarsulehry55 @samy69062958 @Savior_16 @Seohan3724 @ShanQuesq @skybluenalpha @Staunch_idool64 @StoryMofi @sven_336 @Tarique_tapi @tensyonado18 @thejediworld77 @TradeTraine @VJBillionz1 @vulvanic @vutuemay1508 @vutuyetmoon @WelliamCai @wind_catcher23 @zare_obi @zoomdread @Zyvareth
`;
