...
const KNOWN_PACKAGES = [
  ...
  { id: '0x98765cc3765324148db9815da8bce85e6ca895e94eed910b6cc9bec55cc22895', name: 'Prediction', description: 'Prediction markets', category: 'protocol' as const },
  { id: '0xd56f405af7127a15e30a5104ec91574a7483699e5ac1d74383ed5478aee43900', name: 'Lottery', description: 'On-chain lottery (Sui Random)', category: 'protocol' as const },
  { id: '0x3a3babecdd13b588c29fcd854819fc79f050ac7a7919b41d24ba66ab21dc1de3', name: 'Governance V1', description: 'On-chain governance', category: 'protocol' as const },
  { id: '0xe2fb0947f43473e21d1f8aef40e1d6799aa61b3d4fa80b6a1973d1e658de1256', name: 'Governance V2', description: 'Upgraded governance', category: 'protocol' as const },
  ...
  { id: '0x8a0acb40e5546a01e276a367e583df32b134306ebce6118cc01d9e164edf4c1c', name: 'Oracle', description: 'Dev price feed oracle', category: 'protocol' as const },
  { id: '0xdd1e36881a1d47ad4f0f331b6a949948f308ded71c1d46802f23e258ca1ebafe', name: 'Lending', description: 'Lending protocol', category: 'protocol' as const },
  { id: '0x5bdbf3aaa5999674bea412f2dd7dce417a188343f7213cb7105d9c1eaacce31d', name: 'Margin', description: 'Unified margin (multi-collateral)', category: 'protocol' as const },
  { id: '0x6821a73cfc3cd45dc6318db379c2c88f0acb61ec6a26060f4de8cbe4718d3658', name: 'Perpetuals', description: 'Perpetual DEX', category: 'protocol' as const },
  { id: '0x097e96d5e0c09915b6ba2ed744fe2d4ee0bd21df1d453e6528d4d82c96c1c44b', name: 'NSA V1', description: 'Nasun Smart Account', category: 'protocol' as const },
  { id: '0x566eb1ba9e403dcd46c33c45d9a023570f09327b35bde4b8d6fd8b63e70012f3', name: 'NSA V2', description: 'Upgraded Smart Account', category: 'protocol' as const },
];

type Category = 'system' | 'protocol' | 'baram';

const CATEGORY_VARIANT: Record<Category, 'immutable' | 'info' | 'shared'> = {
  system: 'immutable',
  protocol: 'info',
  baram: 'shared',
};
