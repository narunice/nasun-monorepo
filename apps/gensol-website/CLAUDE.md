...
- **Nasun Network** (`../nasun-website`): X(Twitter) 커뮤니티 관리 및 리더보드 인프라를 제공하는 상위 플랫폼
...
### Tech Stack
- **React 19 + TypeScript 5.9** with Vite 7 for build tooling
