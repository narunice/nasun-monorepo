...
- **Nasun Network** (`/home/naru/my_apps/nasun-apps/nasun-website`): X(Twitter) 커뮤니티 관리 및 리더보드 인프라를 제공하는 상위 플랫폼
...
```bash
cd /home/naru/my_apps/nasun-apps
...
**관련 파일**: `/home/naru/my_apps/nasun-apps/nasun-website/cdk/bin/cdk.ts`
...
Nasun Network의 상세 문서는 `/home/naru/my_apps/nasun-apps/nasun-website/CLAUDE.md` 참조:
