/**
 * AssistantMessage - AI response bubble with TEE badge and metadata
 */
...
export function AssistantMessage({
  ...
  return (
    <div className="flex justify-start">
      <div className="max-w-[85%] bg-[var(--color-bg-secondary)] rounded-2xl rounded-tl-md px-4 py-3">
        {/* Header */}
        <div className="flex items-center gap-2 mb-2">
          <div className="flex items-center gap-1.5 text-baram-1">
            ...
            <span className="text-xs font-medium">Baram AI</span>
          </div>
          {timeString && (
        ...
        {isProcessing ? (
          ...
          <>
            <p className="text-sm text-[var(--color-text-primary)] whitespace-pre-wrap mb-3">
              {content}
            </p>
