...
**File**: `apps/baram/frontend/src/features/agents/hooks/useAgentBudgets.ts`
...
4. `apps/baram/frontend/src/config/network.ts` - Added to `BARAM_CONFIG`
5. `apps/baram/frontend/src/features/agents/hooks/useAgentBudgets.ts` - Use `budgetV2TypeOrigin`
...
**File**: `apps/baram/frontend/src/layouts/DashboardLayout.tsx`
...
**File (NEW)**: `apps/baram/frontend/src/components/chat/ChatTopBar.tsx`
...
**File (NEW)**: `apps/baram/frontend/src/components/chat/ChatSessionDrawer.tsx`
...
**File (NEW)**: `apps/baram/frontend/src/pages/ChatPage.tsx`
...
**File**: `apps/baram/frontend/src/App.tsx`
...
```
apps/baram/frontend/src/features/agents/hooks/useAgentBudgets.ts  (3 fixes)
apps/baram/frontend/src/features/agents/hooks/useAgentProfiles.ts (rename)
apps/baram/frontend/src/pages/AgentDetail.tsx                     (rename)
apps/baram/frontend/src/pages/AgentList.tsx                       (rename)
apps/baram/frontend/src/config/network.ts                        (budgetV2TypeOrigin)
