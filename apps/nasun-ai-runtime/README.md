...
- Big-picture: [<CLAUDE_DIR>/plans/pick-an-executor-majestic-thacker.md](../../../.claude/plans/pick-an-executor-majestic-thacker.md)
- Plan D (conversational wake): [<CLAUDE_DIR>/plans/plan-d-conversational-wake.md](../../../.claude/plans/plan-d-conversational-wake.md)
